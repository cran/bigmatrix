...
void tiger_clime_hadm(double * Sigma, double * SS, double * omg, double * x, int *dd, int * ite_cnt_ext, int * ite_cnt_ext2, int * ite_cnt_int1, int * ite_cnt_int2, double * lambda, int *nnlambda, double * gamma, double * gamma2, int * max_ite, double * rho, int *col_cnz, int *row_idx, double * prec, int * verbose)
{
