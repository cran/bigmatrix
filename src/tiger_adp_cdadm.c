...
void tiger_adp_cdadm(double * Sigma, double * wmat, double * omg, double * x, int *dd, int *nn, int * ite_cnt_ext, int * ite_cnt_int1, int * ite_cnt_int2, double * lambda, int *nnlambda, double * gamma, int * max_ite, int *col_cnz, int *row_idx, double * prec)
{
